...
Версия: birthday-js-001-desktop-base-date-validation-strict-date-v034

ИЗМЕНЕНИЯ:
- popup date: единая маска ДД.ММ.ГГГГ и проверка реальной календарной даты без изменения дизайна, меню и остальной логики
- создан desktop JS страницы «День рождения» на базе approved Birthday
- селекторы, переменные и data-атрибуты переведены на birthday
- высота раскрытой галереи изменена на 4045px
- сохранены меню, popup, галерея, lightbox, отзывы, scrolltop и масштабирование
==================================================
*/

...
Версия: birthday-mobile-js-001-base
...
- закрытая высота синхронизирована с макетом: 2064px
- раскрытая высота синхронизирована с макетом: 6102px
...
(function(){
  ...
  var DESIGN = {
    mobile:{
      width:390,
      height:700,
      stageHeightClosed:2064,
      stageHeightOpened:6102
    },
    breakpoint:767
  };
  ...
  var page = document.querySelector('[data-birthday-mobile-page]');
  var stage = document.querySelector('.ip-birthday-mobile-content');
  ...
  var galleryButton = document.querySelector('[data-birthday-mobile-gallery-open]');
  var gallery = document.querySelector('[data-birthday-mobile-gallery]');

  var scrollTopButton = document.querySelector('.ip-birthday-mobile-scrolltop');

  var videoFrame = document.querySelector('[data-birthday-mobile-video-frame]');
  var videoPoster = document.querySelector('[data-birthday-mobile-video-poster]');

  var lightbox = document.querySelector('[data-birthday-mobile-lightbox]');
  var lightboxImage = document.querySelector('[data-birthday-mobile-lightbox-image]');
  var lightboxCounter = document.querySelector('[data-birthday-mobile-lightbox-counter]');
  var lightboxCloseButton = document.querySelector('.ip-birthday-mobile-lightbox-close');
  var lightboxCloseTriggers = Array.prototype.slice.call(
    document.querySelectorAll('[data-birthday-mobile-lightbox-close]')
  );

  var galleryLightboxItems = Array.prototype.slice.call(
    document.querySelectorAll('[data-birthday-mobile-lightbox-open]')
  );
  ...
  function closeGallery(){
    ...
    window.setTimeout(function(){
      ...
      window.requestAnimationFrame(function(){
        scrollToElement(document.querySelector('.ip-birthday-mobile-about'), 36);
      });
    }, 520);
  }

...
Версия: musical-show-js-002-gallery-offset-sync-date-validation-strict-date-v034

ИЗМЕНЕНИЯ:
- popup date: единая маска ДД.ММ.ГГГГ и проверка реальной календарной даты без изменения дизайна, меню и остальной логики
- файл основан на musical-show-js-001-desktop
- высота раскрытой desktop-страницы увеличена после возврата gallery на top:860px
- автоскролл к раскрытой gallery синхронизирован с approved-логикой страницы «Свадьба»
- сохранены меню, popup, отзывы, lightbox, scrolltop и date mask
- mobile JS не создавался и не изменялся
==================================================
*/
...
(function(){
  ...
  var page = document.querySelector('[data-musical-show-page]');
  var stage = document.querySelector('.ip-musical-show-stage');
  ...
  var galleryButton = document.querySelector('[data-musical-show-gallery-open]');
  var gallery = document.querySelector('[data-musical-show-gallery]');

  var scrollTopButton = document.querySelector('.ip-musical-show-scrolltop');
  ...
  function ensureScrollSpacer(){
    ...
    scrollSpacer.setAttribute('data-musical-show-scroll-spacer', '');
  ...
  function updateScrollTopVisibility(){
    ...
    var scaleValue = parseFloat(
      page.style.getPropertyValue('--musical-show-scale')
    );
  ...
  function setupMagneticButtons(){
    ...
    var buttons = Array.prototype.slice.call(
      document.querySelectorAll('.ip-musical-show-button')
    );
  ...
  function getGalleryLightboxItems(){
    ...
    return Array.prototype.slice.call(
      gallery.querySelectorAll('.ip-musical-show-gallery-item img')
    );
  }
  ...
  function updateGalleryLightboxImage(index){
    ...
    galleryLightboxImage.alt = sourceImage.alt || 'Фотография музыкального шоу';
